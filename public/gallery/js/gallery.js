...
export let galleryFrames = [
  ...
  { x: 3, y: 0.5, url: 'https://github.com', title: 'Loading...', user: 'system', svg_image_url: null },
...
async function updateGalleryFrames(uploads) {
  ...
  galleryFrames.forEach((frame, i) => {
    console.log(`🖼️ Painting ${i + 1}: "${frame.title}" by ${frame.user} at (${frame.x}, ${frame.y}) [SVG: ${frame.svg_image_url || 'none'}]`);
  });
